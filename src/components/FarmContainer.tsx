...
const FarmContainer = ({farmId, resetFarmId, userId, forwardFarmUpdate, forwardFarmDelete}: Props) => {
          ...
          <div className="scrollable">
            {farmId !== undefined ? (
              <FarmForm
                ...
                handleFarmDelete={(farmId)=>(forwardFarmDelete(farmId), setShowForm(false))}
              />
            ) : (
              <SearchForm />
            )}
